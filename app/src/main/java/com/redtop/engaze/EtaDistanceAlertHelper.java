        ...
        set.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                ...
                if (emList == null) {
                    ...
                    emList.add(mem);
                    mEvent.ReminderEnabledMembers = emList;
                } else {
        ...
        cancelRemove.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                if (v.getTag() == null) {
                    ...
                    EventParticipant mem = mEvent.ReminderEnabledMembers.get(mEvent.ReminderEnabledMembers.indexOf(cancelRemove.getTag()));
                    mEvent.ReminderEnabledMembers.remove(mem);
                    InternalCaching.saveEventToCache(mEvent);
                    reminderDialog.cancel();
