...
GoogleApiClient.OnConnectionFailedListener, LocationListener {
	...
	private void getParticipantLocationsFromServer(){
		LocationWS.getLocationsFromServer( mMember.getUserId(), mEvent.getEventId(), new OnAPICallCompleteListner() {
	...
	private Boolean checkValidityOfReminder(){	
		...
		mEvent =  InternalCaching.getEventFromCache(mEvent.getEventId());
		if(mEvent == null){
			return false;
		}
		...
		ArrayList<EventParticipant> reminderEnabledMem = mEvent.getReminderEnabledMembers();
